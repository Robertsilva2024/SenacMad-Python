...
print('seu saldo e de:2000')

deposito = 2000 + opcao1
saque = deposito - opcao2
pix = saque + opcao3
recarga = opcao5
saldoanterior = 2000
saldoatual =  2000 + opcao1 + opcao3 - opcao2
saldosobrado = saldoatual - opcao2 - opcao5
...
print('A opção escolhida de Recarga foi A:',opcao4,'\n')
...
print('E Por ultimo a Recarga que foi de',opcao5,'Reais','na',opcao4)
